...
VOBA_FUNC static voba_value_t str_env(voba_value_t self,voba_value_t vs)
{
    ...
    voba_value_t a = voba_apply(voba_symbol_value(s_str), voba_make_tuple(args));
    args[1] = env->parent;
    voba_value_t parent = voba_apply(voba_symbol_value(s_str), voba_make_tuple(args));
    ret = VOBA_STRCAT(ret,
                      VOBA_CONST_CHAR("<ENV"),
...
VOBA_FUNC static voba_value_t str_compiler_fun(voba_value_t self,voba_value_t vs)
{
    ...
    voba_value_t a = voba_apply(voba_symbol_value(s_str), voba_make_tuple(args));
    args[1] = fun->a_var_C;
    voba_value_t c = voba_apply(voba_symbol_value(s_str), voba_make_tuple(args));
    args[1] = fun->parent;
    voba_value_t parent = voba_apply(voba_symbol_value(s_str), voba_make_tuple(args));
    ret = VOBA_STRCAT(ret,
                      VOBA_CONST_CHAR("<FUN"),
